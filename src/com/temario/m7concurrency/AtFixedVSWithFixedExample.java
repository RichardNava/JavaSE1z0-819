...
//        ScheduledFuture<?> scheduledFuture = ses.scheduleWithFixedDelay(task1, 3, 3, TimeUnit.SECONDS);
        ScheduledFuture<?> scheduledFuture = ses.scheduleAtFixedRate(task1, 3, 1, TimeUnit.SECONDS);
    ...
    public void withFixedDelayExample() {
        ...
        // init Delay = 5, repeat the task every 1 second
        ScheduledFuture<?> scheduledFuture = ses.scheduleWithFixedDelay(task1, 3, 1, TimeUnit.SECONDS);
