...
public class StringVSStringBuilder { // String es inmutable - StringBuilder es mutable
    ...
    public void show() {
        ...
        char letra = texto.charAt(texto.length() - 6); // -> Todos los iterables parten de la posición 0(inicio) a //
        // length -1(fin)
        p("charAt()-> " + letra);
    ...
    // INSTRUCCIONES }]
    public void p(String text) { // Podemos sobrecargar un método (tener distintas versiones con el mismo nombre)
        // Instrucciones				
...
//        System.out.println(text);
//    }
//    public void p(boolean text) { // Para sobrecargar un método tenemos que cambiar el número y/o tipo de parametros que 
