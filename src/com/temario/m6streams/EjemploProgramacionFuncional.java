...
public class EjemploProgramacionFuncional {
    ...
    public EjemploProgramacionFuncional() {
        String name = "Alvaro";
        EjemploProgramacionFuncional epf = new EjemploProgramacionFuncional();
        ...
        BiPredicate<String, Integer> biTest2
                = new EjemploProgramacionFuncional()::lengthDistinctNumber;
        //<nombre del objeto o instancia> <::> <nombre del metodo - sin parentesis>
        BiConsumer<String, String> biAccept = epf::miPrint;
        // Si el método no es estático lo utilizamos a traves de la instancia
